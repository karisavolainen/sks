...
// Customizes 'Editor' role to have the ability to modify menus, add new users and more.
class Custom_Admin {
	// Add our filters
	...
	public function init() {
		if ($this->is_client_admin()) {
			// Disable access to the theme pages if not admin
	...
	public function modify_menus() {
		...
		remove_menu_page( 'tools.php' ); // hide the theme selection submenu
